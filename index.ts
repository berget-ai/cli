...
apiKey
  ...
  .action(async (id) => {
    try {
      ...
      console.log('');
      console.log(chalk.dim('Applications using this key will no longer be able to authenticate.'));
...
apiKey
  ...
  .action(async (id, options) => {
    try {
      ...
      console.log('');
      console.log(chalk.dim('Use these statistics to understand your API usage and optimize your costs.'));
    } catch (error) {
